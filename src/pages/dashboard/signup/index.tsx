    ...
    <>
      <Grid container alignItems={'center'} sx={{ height: '80vh' }}>
        <Grid item md={6} xs={12} textAlign='center'>
          <Image src={img} alt='SignupImage' width={300} height={350} />
        </Grid>
          ...
          <Box sx={{ mb: 5 }}>
            <form noValidate autoComplete='off' onSubmit={handleSubmit(onSubmit)}>
              ...
              <Grid item xs={12} sx={{ mb: 4 }}>
                <FormControl fullWidth sx={{ mb: 4 }}>
                  <InputField name='phone' label='Phone' placeholder='Phone' control={control} />
                </FormControl>
              </Grid>
              <FormControl fullWidth sx={{ mb: 4 }}>
              ...
              >
                <Link passHref href='/dashboard/forgot-password'>
