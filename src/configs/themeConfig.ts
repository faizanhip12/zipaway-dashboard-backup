...
const themeConfig: ThemeConfig = {
  // ** Layout Configs
  templateName: 'Zipaway' /* App Name */,
  title: 'Zipaway', /* App title */
  metaDescription: 'Zipaway software', /* App meta description */
  metaKeywords: 'Zipaway software', /* App meta keywords */
